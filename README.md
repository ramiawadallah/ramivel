...
| JWT Api version     | jwt-auth | composer require Ramivel/ramivel -b jwt-auth |
...
Run [the Migration](https://github.com/ramivel/ramiawadallah/database/migrations/create_permission_tables.php) to have tables in your database.
