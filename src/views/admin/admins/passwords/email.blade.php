            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-4 py-4">
                    ...
                    <div class="text-center">
                        ...
                        <h1 class="h4 mb-1">
                            {{ __('Reset ' . ucfirst(config('multiauth.prefix')) . ' password') }}
                        </h1>
                    ...
                    <form method="POST" action="{{ route('admin.password.email') }}" aria-label="{{ __('Reset admin password') }}">
                        ...
                        <div class="py-3">
                            <div class="form-group">
                                <input type="email" class="form-control form-control-lg form-control-alt {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" id="email" name="email" placeholder="{{ __('Your email') }}">
                                @if ($errors->has('email'))
