            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-4 py-4">
                    ...
                    <div class="text-center">
                        ...
                        <h1 class="h4 mb-1">
                            {{ ucfirst(config('multiauth.prefix')) }} Sign In
                        </h1>
                    ...
                    <form  method="POST" action="{{ route('admin.login') }}" aria-label="{{ __('Admin Login') }}">
                        ...
                        <div class="py-3">
                            <div class="form-group">
                                <input type="email" class="form-control form-control-lg form-control-alt {{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" name="email" placeholder="Your Email">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control form-control-lg form-control-alt {{ $errors->has('password') ? ' is-invalid' : '' }}" id="assword" name="password" placeholder="Password">
