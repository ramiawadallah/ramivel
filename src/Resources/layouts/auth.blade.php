    ...
    <body>
        ...
        <!-- Footer -->
            <div class="font-size-sm text-center text-muted py-3">
                <strong>Crafted with <i class="fa fa-heart text-danger"></i> by <a class="font-w600" href="https://ramiawadallah.com" target="_blank">Rami Awadallah</a></strong> &copy; 
                <a class="font-w600" href="https://ramiawadallah.com" target="_blank">RAMVEL 1.0</a> &copy; <span data-toggle="year-copy"></span>
            </div>
        <!-- Footer -->
