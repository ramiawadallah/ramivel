...
class MultiauthServiceProvider extends ServiceProvider
{
    ...
    protected function publisheThings()
    {
        ...
        $this->publishes([
               ...
               __DIR__ . '/Http/Relation'                   => app_path(),                                //  Relation
               __DIR__ . '/Http/Template'                   => app_path(),                                //  Template
               ...
               __DIR__ . '/routes/web.php'                  => base_path("routes/web.php"),               //  Routes / Web
               __DIR__ . '/Model'                           => app_path(),                                //  Model
               __DIR__ . '/Themes'                          => public_path('/themes/'),                   //  Themes
               __DIR__ . '/Support'                         => app_path('Helpers/'),                      //  Helpers
               __DIR__ . '/Config/cms.php'                  => config_path('cms.php'),                    //  Config
           ]
            ,'ramivel:publish');
    }
